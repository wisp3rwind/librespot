...
impl RequestHandler {
    ...
    fn handle_add_user(&self, params: &Params<'_>) -> Result<Response<Full<Bytes>>, Error> {
...

        {
            ...
            self.event_tx.send(DiscoveryEvent::Credentials(credentials))?;
...
impl DiscoveryServer {
    pub fn new(config: Config, port: &mut u16, event_tx: mpsc::UnboundedSender<DiscoveryEvent>) -> Result<Self, Error> {
